...
Pagination.prototype.jinyong = function() {
        ...
        if (pagenum2 == 1) {
            //禁用首页和上一页
            divs[0].style.backgroundColor = "#f0f0f0"
            divs[1].style.backgroundColor = "#f0f0f0"
        }
        if (pagenum2 == totalPage2) {
            //禁用下一页和尾页
            divs[3].style.backgroundColor = "#f0f0f0"
            divs[4].style.backgroundColor = "#f0f0f0"
        }
    }
    //显示文本信息
