...
// 价格范围
$st1="rongji>600";
$st2="rongji>=501 and rongji<=600";
$st3="rongji>=301 and rongji <=500";
$st4="rongji>=201 and rongji<=300";
$st5="rongji>=101 and rongji<=200";
$st6="rongji>0 and rongji<=100";
;
// SQL语句
if($num==1){
    if($u%2==0){
        $sql="select * from shop where $st1 order by rongji desc";
    }else{
        $sql="select * from shop where $st1 order by rongji asc";
    }
...
if($num==2){
    if($u%2==0){
        $sql="select * from shop where $st2 order by rongji desc";
    }else{
        $sql="select * from shop where $st2 order by rongji asc";
    }
    // if(!empty($user)&&!empty($pwd)&&!empty($u)){
    //     if($u%2==0){
    //         echo 1;
...
if($num==3){
    if($u%2==0){
        $sql="select * from shop where $st3 order by rongji desc";
    }else{
        $sql="select * from shop where $st3 order by rongji asc";
    }
    // if(!empty($user)&&!empty($pwd)&&!empty($u)){
    //     if($u%2==0){
...
if($num==4){
    if($u%2==0){
        $sql="select * from shop where $st4 order by rongji desc";
    }else{
        $sql="select * from shop where $st4 order by rongji asc";
    }
    // if(!empty($user)&&!empty($pwd)&&!empty($u)){
    //     if($u%2==0){
...
if($num==5){
    if($u%2==0){
        $sql="select * from shop where $st5 order by rongji desc";
    }else{
        $sql="select * from shop where $st5 order by rongji asc";
    }
    // if(!empty($user)&&!empty($pwd)&&!empty($u)){
    //     if($u%2==0){
...
if($num==6){
    if($u%2==0){
        $sql="select * from shop where $st6 order by rongji desc";
    }else{
        $sql="select * from shop where $st6 order by rongji asc";
    }
    // if(!empty($user)&&!empty($pwd)&&!empty($u)){
    //     if($u%2==0){
